<template>
    <div class="flex justify-between max-w-7xl mx-auto px-4 md:px-16 py-3 text-brand-black-3 font-semibold">
        <a class="pb-2 text-xl border-b-4 border-transparent hover:border-b-4 hover:border-brand-black-3"
