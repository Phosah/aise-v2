                ...
                <div class="hidden md:flex items-center space-x-6 mb-10 dark:text-white">
                    <div class="flex-1">
                        <img
                            ...
                            class="w-full"
                            src="../assets/other-works/opportunities-graph-1.png"
                            alt="Opportunities graph"
                        />
                        <img
                            v-else
                            class="w-full"
                            src="../assets/other-works/opportunities-graph-dark-1.png"
                            alt="Opportunities graph"
                        />
                    </div>
                    <div class="flex-1">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                ...
                <div class="md:flex items-center md:space-x-10 mb-16 md:mb-32">
                    ...
                    <div class="hidden md:block md:flex-1">
                        <img src="../assets/other-works/create-bank-account.png" alt="Create bank account" />
                    </div>
                    <!-- Mobile version -->
                    <div class="block md:hidden">
                        <img
                            src="../assets/other-works/create-bank-account-mobile.png"
                ...
                <div class="hidden md:flex items-center space-x-10 mb-32">
                    <div class="flex-1">
                        <img
                            class="w-full"
                            src="../assets/other-works/crypto-payments.png"
                            alt="Crypto payments"
                        />
                    </div>
                    <div class="flex-1">
                ...
                <div class="md:flex md:items-center md:space-x-10 mb-16 md:mb-32">
                    ...
                    <div class="hidden md:block md:flex-1">
                        <img class="w-full" src="../assets/other-works/lending.png" alt="Lending and Leverage" />
                    </div>
                    <!-- Mobile version -->
                    <div class="block md:hidden">
                        <img
                            class="w-full"
                            src="../assets/other-works/lending-mobile.png"
                ...
                <div class="hidden md:flex items-center space-x-10 mb-32">
                    <div class="flex-1">
                        <img
                            class="w-full"
                            src="../assets/other-works/dollar-cards.png"
                ...
                <div class="md:flex md:items-center md:space-x-10 mb-16 md:mb-32">
                    ...
                    <div class="hidden md:block md:flex-1">
                        <img
                            class="w-full"
                            src="../assets/other-works/offline-transaction.png"
                    ...
                    <div class="block md:hidden">
                        <img
                            class="w-full"
                            src="../assets/other-works/offline-transaction-mobile.png"
                            alt="Offline transaction"
                        />
                    </div>
                    <!-- End of Mobile version -->
